...
typedef  struct _HID_DESCRIPTOR {
  ...
  } __attribute__((packed)) DescriptorList[1];
...
#define EP0_TXBUFF_LENGTH_BYTES 	USB_MAX_PACKET0
// RX Buff size 64 bytes = 2 block by 32 bytes
#define EP0_RXBUFF_LENGTH_BYTES 	USB_MAX_PACKET0
...
// EP1 - interrupt IN for reading reports by the host
#define EP1_TXBUFF_LENGTH_BYTES 	64
