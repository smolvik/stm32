...
Begun.richBlocks = function(element, options) {
	...
	for (var i = 0; i < num_pics; i++) {
        ...
        this['INITIAL_LEFT_MIN_' + i] = sizes['offset_left_min_' + i] || 0;
        this['INITIAL_LEFT_MAX_' + i] = sizes['offset_left_max_' + i] || 0;
        this['INITIAL_TOP_MIN_' + i] = sizes['offset_top_min_' + i] || 0;
        this['INITIAL_TOP_MAX_' + i] = sizes['offset_top_max_' + i] || 0;
	}
...
Begun.richBlocks.prototype = {
	...
	zoomOut: function(img) {
		...
		this.start(img, {
			top: this['INITIAL_TOP_MIN_' + img._i],
			left: this['INITIAL_LEFT_MIN_' + img._i],
